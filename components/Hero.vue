    ...
    <v-container fluid>
      <v-row>
        <v-col class="px-0 d-none d-md-block" cols="12">
          ...
          <v-img src="/images/hero/hero-8.JPG" height="70vh" cover lazy-src="/images/hero/hero-3.jpg"></v-img>
        </v-col>
      </v-row>
...
<style scoped>
.custom-button {
  background-color: #1d1d2b; /* Dark background color */
  color: #ffb400; /* Gold text color */
  padding: 10px 20px;
  font-size: 16px;
  font-weight: bold;
  border: none;
  cursor: pointer;
  transform: skewX(-10deg); /* Adds angled effect */
  transition: background-color 0.3s ease;
}

.custom-button:hover {
  background-color: #333344; /* Darker shade on hover */
}
.background-black {
